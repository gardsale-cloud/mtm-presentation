...
<div class="slide-main slide-11-layout">
    ...
    <section class="title-section">
        <h1 class="slide-title">
            Предлагаю сначала проверить результат
        </h1>
        <p class="slide-subtitle">
            Не обязательно сразу менять весь сайт. Можно сначала протестировать&nbsp;</p>
    </section>
        ...
        <div class="test-timeline">
            ...
            <div class="timeline-step step-active">
                ...
                <div class="timeline-content">
                    ...
                    <span class="timeline-text">Подготовить новую версию сайта</span>
                </div>
            </div>
            ...
            <div class="timeline-step">
                ...
                <div class="timeline-content">
                    ...
                    <span class="timeline-text">Направить часть посетителей из рекламы на новый сайт</span>
                </div>
            </div>
            ...
            <div class="timeline-step">
                ...
                <div class="timeline-content">
                    ...
                    <span class="timeline-text">Принять взвешенное решение о дальнейшем переходе</span>
                </div>
            </div>
        </div>
    ...
    <section class="highlight-conclusion-card">
        <p>Главная цель теста — не просто сделать новый сайт, а проверить, помогает ли он получать больше обращений.</p>
    </section>
</div>
