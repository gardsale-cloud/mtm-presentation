...
<div class="slide-main slide-6-layout">
    ...
    <section class="title-section">
        ...
        <p class="slide-subtitle">
            Большинство покупателей не знают точных названий материалов, их плотности или технических характеристик. Они приходят на сайт с простой задачей.
        </p>
    </section>
    ...
    <div class="solutions-container">
        <h2 class="solutions-title">Что поможет покупателю быстрее выбрать материал</h2>
        ...
        <div class="solutions-grid">
            ...
            <div class="solution-pill">
                ...
                <span class="solution-text">Удобные и понятные фильтры</span>
            </div>
            ...
            <div class="solution-pill">
                ...
                <span class="solution-text">Недавно просмотренные товары</span>
            </div>
