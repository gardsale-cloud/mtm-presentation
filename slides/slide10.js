...
<div class="slide-main slide-10-layout">
    ...
    <section class="title-section">
        ...
        <p class="slide-subtitle">
            Есть несколько вариантов. Главный вопрос — как быстро компания хочет развивать сайт дальше.
        </p>
    </section>

    <!-- Three Options Comparison Grid -->
    <div class="options-grid-3">
        ...
        <!-- Option 2 -->
        <div class="option-card">
            <h2 class="option-card-title">2. Улучшать текущий сайт</h2>
            <p class="option-card-desc">Постепенно добавлять новые функции и исправлять проблемы.</p>
